/**
 * Update Thursday & Saturday PP services in April-May to use Cabot Pollenca
 */
...
async function main() {
  console.log('\n=== Finding Thursday & Saturday PP Services in April-May 2026 ===\n');
  ...
  for (const service of services) {
    const dayOfWeek = service.serviceDate.getDay(); // 0=Sunday, 4=Thursday, 6=Saturday
  ...
  console.log(`\nFound ${toUpdate.length} Thursday/Saturday services to update:\n`);
  ...
  console.log(`\n=== Summary ===`);
  console.log(`✓ Updated: ${updated} services to use Cabot Pollenca (Route ID: 19)`);
}
