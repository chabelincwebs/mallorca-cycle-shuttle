/**
 * Update Monday PP services in April-May to use Cabot Pollenca
 */
...
async function main() {
  console.log('\n=== Finding Monday PP Services in April-May 2026 ===\n');
  ...
  for (const service of services) {
    const dayOfWeek = service.serviceDate.getDay(); // 0=Sunday, 1=Monday, etc.
  ...
  console.log(`\nFound ${toUpdate.length} Monday services to update:\n`);
  ...
  console.log(`\n=== Summary ===`);
  console.log(`✓ Updated: ${updated} Monday services to use Cabot Pollenca (Route ID: 19)`);
}
