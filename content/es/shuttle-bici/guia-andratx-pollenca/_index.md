---
title: "Guía maestra de ciclismo: Andratx a Pollença"
description: "Guía completa para pedalear de Andratx a Pollença por la sierra de Tramuntana"
translationKey: "guide-andratx-pollenca"
---

<p class="header-subtitle">
No decimos que sea fácil. No decimos que sea para todo el mundo.
</p>
...
<p>11 rutas diferentes con descargas GPX completas y perfiles de elevación</p>
</div>
</div>
...
<h3>Majestad de la montaña</h3>
</div>
<div class="info-card-content">
<p>Recorre la Serra de Tramuntana, Patrimonio Mundial de la UNESCO</p>
</div>
</div>
...
<h3>Subidas épicas</h3>
</div>
<div class="info-card-content">
<p>Conquista puertos legendarios como Sa Calobra y Puig Major</p>
</div>
</div>
...
<h3>Belleza costera</h3>
</div>
<div class="info-card-content">
<p>Vistas mediterráneas espectaculares y encantadores pueblos costeros</p>
</div>
</div>
...
<h3>Carreteras perfectas</h3>
</div>
<div class="info-card-content">
<p>Asfalto liso, carriles amplios e infraestructura amigable con la bici</p>
</div>
</div>
...
<div class="info-card-content">
<p>Cafés tradicionales mallorquines, perfectamente espaciados para las paradas</p>
</div>
</div>
...
<h3>Pedaleo todo el año</h3>
</div>
<div class="info-card-content">
<p>Clima mediterráneo suave, ideal para pedalear más de 10 meses al año</p>
</div>
</div>
...
<h3>Primero la seguridad</h3>
</div>
<div class="info-card-content">
<p>Carreteras bien mantenidas con carriles bici señalizados en muchas zonas</p>
</div>
</div>
...
<h3>Equipamiento de finisher</h3>
</div>
<div class="info-card-content">
<p>Conmemora tu ruta épica con merchandising exclusivo</p>
</div>
</div>
...
<div class="info-card-content">
<p>Consejos internos sobre mejores horarios, clima y rincones ocultos</p>
</div>
</div>
...
<div class="info-card-content">
<p>Rutas para todos los niveles - de moderadas a retos muy duros</p>
</div>
</div>
...
<div class="info-card-content">
<p>Reserva tu shuttle de bicicletas para empezar tu aventura</p>
</div>
</div>
...
<div class="route-accordion">
  ...
  <div class="route-item" id="route-north-1">
    <div class="route-header" onclick="toggleRoute('north-1')">
      <div class="route-title-section">
        ...
        <div>
          <div class="route-title">Estándar – Port d'Andratx → Port de Pollença</div>
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Tramo costero → Puig Major (lado fácil) → 14 km de bajada a Sóller → carretera costera por Deià, Valldemossa, Banyalbufar, Estellencs. La ruta directa. ¡Espectacular!</p>
  ...
  <div class="route-item" id="route-north-2">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Igual que Estándar pero girando al interior tras Sóller → ascenso a Orient → Alaró → Caimari → Lluc → Pollença. Variante interior escénica.</p>
  ...
  <div class="route-item" id="route-north-3">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Tramo costero + bajada a Port Valldemossa y subida de regreso (400 m de desnivel de bajada y subida en cada sentido) → luego final costero estándar. Añadido duro.</p>
  ...
  <div class="route-item" id="route-north-4">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Tramo costero + Port Valldemossa, luego Puig Major → izquierda en el acueducto → Coll dels Reis → bajar Sa Calobra, subir de vuelta → Lluc → bajar a Pollença. Dura.</p>
  ...
  <div class="route-item" id="route-north-5">
    <div class="route-header" onclick="toggleRoute('north-5')">
      <div class="route-title-section">
        <span class="route-icon">▶</span>
        <div>
          <div class="route-title">El Gran Desafío (8 puertos clasificados)</div>
          <div class="route-stats-inline">
            <span>📏 162 km</span>
            <span>⛰️ 4,267 m</span>
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Tramo costero + Port des Canonge + Port Valldemossa → lado largo de Puig Major → acueducto → Coll dels Reis → Sa Calobra (bajar y subir) → Lluc → Pollença/Port. Muy dura.</p>
  ...
  <div class="route-item" id="route-north-6">
    <div class="route-header" onclick="toggleRoute('north-6')">
      <div class="route-title-section">
        <span class="route-icon">▶</span>
        <div>
          <div class="route-title">Vuelta por el Coll de Sóller y el Valle de Orient</div>
          <div class="route-stats-inline">
            <span>📏 137 km</span>
            <span>⛰️ 2,360 m</span>
            <span class="difficulty-badge difficulty-hard">Hard</span>
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Completa el clásico tramo costero y afronta después las 51 curvas del Coll de Sóller antes de rodar por el tranquilo Valle de Orient. Otra más para los escaladores. Gran día. ¡Los recovery de esa noche estarán bien ganados!</p>
...
<div class="route-accordion">
  ...
  <div class="route-item" id="route-south-1">
    <div class="route-header" onclick="toggleRoute('south-1')">
      <div class="route-title-section">
        <span class="route-icon">▶</span>
        <div>
          <div class="route-title">Estándar – Port de Pollença → Port d'Andratx</div>
          <div class="route-stats-inline">
            <span>📏 121 km</span>
            <span>⛰️ 2,700 m</span>
            <span class="difficulty-badge difficulty-moderate">Moderate</span>
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Coll de Femenia → pasar el desvío de Lluc/Sa Calobra → lado fácil de Puig Major → 14 km de bajada a Sóller → costa por Deià, Valldemossa, Banyalbufar, Estellencs → Port d'Andratx. La vuelta más directa. ¡Espectacular!</p>
  ...
  <div class="route-item" id="route-south-2">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Femenia → Lluc → Puig Major → Sóller → costa + añadidos: bajar y regresar a Port des Canonge y Port Valldemossa → final costero suroeste hasta Andratx.</p>
  ...
  <div class="route-item" id="route-south-3">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Femenia → Lluc → Puig Major → Sóller → Deià → Valldemossa → Esporles → Puigpunyent → Galilea → Es Capdellà → Port d'Andratx. ¡Pasa un rato lejos de la costa y fuera del circuito!</p>
  ...
  <div class="route-item" id="route-south-4">
    <div class="route-header" onclick="toggleRoute('south-4')">
      <div class="route-title-section">
        <span class="route-icon">▶</span>
        <div>
          <div class="route-title">El Gran Desafío (reverse)</div>
          <div class="route-stats-inline">
            <span>📏 167 km</span>
            <span>⛰️ 4,121 m</span>
            <span class="difficulty-badge difficulty-very-hard">Very Hard</span>
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Conceptualmente como arriba, incluyendo los tres "ports" (Canonge, Valldemossa, Sa Calobra). Solo para escaladores fuertes.</p>
  ...
  <div class="route-item" id="route-south-5">
    <div class="route-header" onclick="toggleRoute('south-5')">
      <div class="route-title-section">
        <span class="route-icon">▶</span>
        <div>
          <div class="route-title">Vuelta por Cap de Formentor</div>
          <div class="route-stats-inline">
            <span>📏 162 km</span>
            <span>⛰️ 3,500 m</span>
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Completa el clásico coast-to-coast incluyendo lo que para algunos son los mejores 20 km de carretera para ciclistas en Europa: la ida y vuelta al faro de Cap de Formentor. ¡Día épico!</p>
      ...
      plugins: {
        ...
        tooltip: {
          callbacks: {
            ...
            label: (context) => 'Elevación: ' + context.parsed.y.toFixed(0) + ' m'
          }
        }
      },
      scales: {
...
<img src="/img/finishers-tshirt-andratx-pollenca.webp" alt="Camiseta Finisher Andratx-Pollença" style="width: 100%; height: 100%; object-fit: cover; display: block;">
</div>
...
<p style="color: #666; font-size: 1rem; margin-bottom: 1.5rem; line-height: 1.6;">Celebra haber completado esta ruta épica con nuestra camiseta de finisher exclusiva. Disponible en varios colores y tallas.</p>
