...
**Schwierigkeit:** Mittel bis fortgeschritten (Exposition + Wind + Verkehr)
...
<div class="route-accordion">
  ...
  <!-- Route 3: Port de Pollença via Cap de Formentor to Playa de Palma -->
  ...
  <!-- Route 4: Pollença to Andratx via Formentor -->
