---
title: "Guide maître de cyclisme : Andratx à Pollença"
...
On ne dit pas que c'est facile. On ne dit pas que c'est pour tout le monde.
</p>
...
<p>11 itinéraires différents avec téléchargements GPX complets et profils d'élévation</p>
</div>
</div>
...
<h3>Majesté des montagnes</h3>
</div>
<div class="info-card-content">
<p>Traverse la Serra de Tramuntana, classée au patrimoine mondial de l'UNESCO</p>
</div>
</div>
...
<h3>Montées épiques</h3>
</div>
<div class="info-card-content">
<p>Conquiers des cols légendaires dont Sa Calobra et Puig Major</p>
</div>
</div>
...
<h3>Beauté côtière</h3>
</div>
<div class="info-card-content">
<p>Vues méditerranéennes superbes et villages côtiers charmants</p>
</div>
</div>
...
<h3>Routes parfaites</h3>
</div>
<div class="info-card-content">
<p>Bitume lisse, voies larges et infrastructures favorables aux cyclistes</p>
</div>
</div>
...
<div class="info-card-content">
<p>Cafés traditionnels majorquins, idéalement espacés pour les arrêts</p>
</div>
</div>
...
<h3>Vélo toute l'année</h3>
</div>
<div class="info-card-content">
<p>Climat méditerranéen doux, idéal pour rouler plus de 10 mois par an</p>
</div>
</div>
...
<div class="info-card-content">
<p>Routes bien entretenues avec bandes cyclables dédiées dans de nombreuses zones</p>
</div>
</div>
...
<h3>Équipement de finisher</h3>
</div>
<div class="info-card-content">
<p>Commémore ta sortie épique avec du merchandising exclusif</p>
</div>
</div>
...
<div class="info-card-content">
<p>Bons plans sur les meilleurs horaires, la météo et les pépites cachées</p>
</div>
</div>
...
<div class="info-card-content">
<p>Itinéraires pour tous les niveaux – de modérés à défis très durs</p>
</div>
</div>
...
<h3>Réserve ton shuttle</h3>
</div>
<div class="info-card-content">
<p>Réserve ta navette vélo pour lancer ton aventure</p>
</div>
</div>
...
<h2 id="north-routes" class="route-direction-header">Itinéraires Nord – Andratx → Pollença</h2>
</div>
...
<div class="route-accordion">
  ...
  <div class="route-item" id="route-north-1">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Section côtière → Puig Major (côté facile) → 14 km de descente vers Sóller → route côtière via Deià, Valldemossa, Banyalbufar, Estellencs. L'itinéraire direct. Brillant !</p>
  ...
  <div class="route-item" id="route-north-2">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Comme Standard mais virage vers l'intérieur après Sóller → montée vers Orient → Alaró → Caimari → Lluc → Pollença. Variante intérieure scénique.</p>
  ...
  <div class="route-item" id="route-north-3">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Section côtière + plongée vers Port Valldemossa puis remontée (400 m de descente & montée à l'aller comme au retour) → puis final côtier standard. Ajout costaud.</p>
  ...
  <div class="route-item" id="route-north-4">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Section côtière + Port Valldemossa, puis Puig Major → à gauche à l'aqueduc → Coll dels Reis → descente de Sa Calobra, remontée → Lluc → descente vers Pollença. Dur.</p>
  ...
  <div class="route-item" id="route-north-5">
    <div class="route-header" onclick="toggleRoute('north-5')">
      <div class="route-title-section">
        <span class="route-icon">▶</span>
        <div>
          <div class="route-title">Le Grand Défi (8 cols classés)</div>
          <div class="route-stats-inline">
            <span>📏 162 km</span>
            <span>⛰️ 4,267 m</span>
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Section côtière + Port des Canonge + Port Valldemossa → grand côté de Puig Major → aqueduc → Coll dels Reis → Sa Calobra (descendre & remonter) → Lluc → Pollença/Port. Très dur.</p>
  ...
  <div class="route-item" id="route-north-6">
    <div class="route-header" onclick="toggleRoute('north-6')">
      <div class="route-title-section">
        <span class="route-icon">▶</span>
        <div>
          <div class="route-title">Retour via le Coll de Sóller et la vallée d'Orient</div>
          <div class="route-stats-inline">
            <span>📏 137 km</span>
            <span>⛰️ 2,360 m</span>
            <span class="difficulty-badge difficulty-hard">Hard</span>
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Termine la section côtière classique puis enchaîne les 51 lacets en passant par le Coll de Sóller avant de filer dans la paisible vallée d'Orient. Encore un pour les grimpeurs. Super journée. Les boissons de récup seront bien méritées le soir !</p>
...
<div class="route-section">
<h2 id="south-routes" class="route-direction-header">Itinéraires Sud – Pollença → Andratx</h2>
</div>

<div class="route-accordion">
  <!-- Route 6: South Standard -->
  <div class="route-item" id="route-south-1">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Coll de Femenia → passer le carrefour Lluc/Sa Calobra → côté facile de Puig Major → 14 km de descente vers Sóller → côte via Deià, Valldemossa, Banyalbufar, Estellencs → Port d'Andratx. Le retour le plus direct. Brillant !</p>
  ...
  <div class="route-item" id="route-south-2">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Femenia → Lluc → Puig Major → Sóller → côte + ajouts : aller-retour à Port des Canonge et Port Valldemossa → final côtier sud-ouest vers Andratx.</p>
  ...
  <div class="route-item" id="route-south-3">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Femenia → Lluc → Puig Major → Sóller → Deià → Valldemossa → Esporles → Puigpunyent → Galilea → Es Capdellà → Port d'Andratx. Passe un moment loin de la côte et hors des sentiers battus !</p>
  ...
  <div class="route-item" id="route-south-4">
    <div class="route-header" onclick="toggleRoute('south-4')">
      <div class="route-title-section">
        <span class="route-icon">▶</span>
        <div>
          <div class="route-title">Le Grand Défi (reverse)</div>
          <div class="route-stats-inline">
            <span>📏 167 km</span>
            <span>⛰️ 4,121 m</span>
            <span class="difficulty-badge difficulty-very-hard">Very Hard</span>
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Même concept que ci-dessus, incluant les trois « ports » (Canonge, Valldemossa, Sa Calobra). Uniquement pour grimpeurs solides.</p>
  ...
  <div class="route-item" id="route-south-5">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Achève le classique coast-to-coast en incluant ce que certains considèrent comme les meilleurs 20 km de route cycliste en Europe : l'aller-retour au phare de Cap de Formentor. Journée épique !</p>
...
<h2 style="color: var(--brand, #f10000); margin-bottom: 0.75rem; font-size: 1.75rem; font-weight: 700;">Commémore ta sortie</h2>
<h3 style="color: #333; font-size: 1.2rem; font-weight: 600; margin-bottom: 0.75rem;">T-shirt Finisher Andratx-Pollença</h3>
<p style="color: #666; font-size: 1rem; margin-bottom: 1.5rem; line-height: 1.6;">Célèbre l'accomplissement de cet itinéraire épique avec notre t-shirt de finisher exclusif. Disponible en plusieurs couleurs et tailles.</p>
