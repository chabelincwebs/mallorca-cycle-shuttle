...
description: "Traversée épique d'une journée de la Serra de Tramuntana de Majorque avec 8 cols classifiés et ports bonus optionnels"
translationKey: "guide-big-daddy"
type: "bike-shuttle"
---

<p class="header-subtitle">
Vélo à l'aller, bus au retour.
</p>

<div class="hero-intro-banner">
<div class="hero-intro-content">
<p class="hero-intro-centered fade-in-up">
Sera-ce votre <strong>meilleur jour à vélo ?</strong>
</p>
<p class="hero-intro-main fade-in-up delay-1">
Une traversée épique d'une journée de la <span class="highlight">Serra de Tramuntana de Majorque</span> avec trois ports « bonus » optionnels pour plus de défi : <strong>Port des Canonge</strong>, <strong>Port de Valldemossa</strong> et <strong>Port de Sa Calobra</strong>
</p>
<p class="hero-intro-features fade-in-up delay-2">
Asphalte ultra-lisse • 8 cols classifiés • Falaises côtières • Forêt de pins • Hautes montagnes • Villages-cafés fréquents
</p>
</div>
</div>
...
/* Typography Reset - Apple Style */
h1, h2, h3, p {
  font-family: var(--font-system);
  letter-spacing: -0.015em;
}

/* Page Title - Apple Hero Style */
h1 {
  text-align: center;
  margin-bottom: 1rem;
...
/* Header Subtitle - Apple Subheadline */
.header-subtitle {
  font-size: 1.25rem;
  line-height: 1.5;
...
/* Hero Intro Banner - Apple Card Design */
.hero-intro-banner {
  margin: 0 0 2rem 0;
...
.hero-intro-banner::before {
  ...
  right: 0;
  bottom: 0;
  background: linear-gradient(135deg, rgba(241, 0, 0, 0.02) 0%, rgba(255, 51, 51, 0.01) 100%);
  z-index: 0;
}
...
<p><strong>Distance et dénivelé :</strong> Environ 162-167 km avec ~4 300 m de dénivelé positif</p>
<p><strong>Cols :</strong> 8 classifiés</p>
<p><strong>Surface :</strong> Asphalte ultra-lisse</p>
<p><strong>Paysages :</strong> Falaises côtières, forêt de pins, hautes montagnes</p>
<p><strong>Points de ravitaillement :</strong> Villages-cafés fréquents</p>
<p><strong>Difficulté :</strong> Pas pour tout le monde – implacable par endroits</p>
</div>
</div>
...
<div class="info-card-content">
<p>Une traversée épique d'une journée de la Serra de Tramuntana de Majorque avec trois ports « bonus » optionnels pour plus de défi : Port des Canonge, Port de Valldemossa et Port de Sa Calobra.</p>
<p>Vous définissez le rythme et la stratégie d'arrêts. Nous vous conduisons au départ en <a href="https://mallorcacycleshuttle.company.site/products/Scheduled-Bike-Buses-c15728235" target="_blank" rel="noopener noreferrer">navette</a> ; vous roulez sur la colonne vertébrale de la chaîne ; vous terminez avec un bus de retour.</p>
<p>Attendez-vous à de longues montées régulières, enchaînées dos à dos. « Implacable » est le mot que les cyclistes utilisent le plus.</p>
</div>
</div>
...
<h3>Concept du parcours</h3>
</div>
<div class="info-card-content">
<p><strong>Bus vélo jusqu'au départ</strong> – partez frais.</p>
<p><strong>Roulez sur la Tramuntana</strong> – assemblez la route côtière classique et les cols de haute montagne.</p>
<p><strong>Ajouts optionnels</strong> – descendez au niveau de la mer à un ou plusieurs ports, puis remontez.</p>
<p><strong>Bus de retour</strong> – jambes en l'air, histoires dehors.</p>
</div>
</div>
...
<div class="info-card-content">
<p><strong>Big Daddy complet :</strong> ~162-167 km / ~4 300 m selon les ajouts</p>
<p><strong>Options de parcours de retour les plus courtes :</strong> À partir de ~115 km / ~2 400 m</p>
<p><strong>Vues :</strong> Vous franchirez 8 cols classifiés parmi les plus belles vues de Majorque – pics calcaires, coteaux en terrasses, criques turquoise. Par temps clair, vous pouvez voir à travers la Méditerranée jusqu'à Barcelone.</p>
</div>
</div>
...
<h3>Stratégie Café</h3>
</div>
<div class="info-card-content">
<p>Si votre carburant de prédilection est l'excellent café accompagné de gâteau ou de tapas, vous avez de la chance. Environ toutes les heures, vous traversez un village avec de bonnes options – Estellencs, Banyalbufar, Deià, Valldemossa, Sóller et plus encore.</p>
<p><strong>Conseil de pro :</strong> Si vous descendez vers n'importe quel Port, vous êtes au niveau de la mer – la seule sortie est vers le haut.</p>
</div>
</div>
...
<h3>Qui devrait le faire</h3>
</div>
<div class="info-card-content">
<p><strong>C'est difficile – très difficile.</strong></p>
<p>C'est une sportive personnelle avec de meilleurs paysages, de meilleures surfaces et généralement de meilleures conditions météo que la plupart des événements.</p>
<p>Si vous n'êtes pas encore prêt, préparez-vous – les souvenirs valent l'effort.</p>
</div>
</div>
...
<h3>Variations et fichiers</h3>
</div>
<div class="info-card-content">
<p>Vous pouvez adapter le défi :</p>
<p><strong>Options de parcours de retour les plus courtes :</strong> À partir de ~115 km / ~2 400 m</p>
<p><strong>Big Daddy complet :</strong> ~162-167 km / ~4 300 m selon les ajouts</p>
<p><strong>Fichiers GPX :</strong> Fichiers GPX complets disponibles ci-dessous.</p>
</div>
</div>
...
<div class="info-card-content">
<p><strong>Vélo à l'aller, bus au retour :</strong> Prenez le <a href="https://mallorcacycleshuttle.company.site/products/Scheduled-Bike-Buses-c15728235" target="_blank" rel="noopener noreferrer">bus vélo programmé</a> jusqu'au départ, roulez le long de la Tramuntana et rejoignez le bus de retour.</p>
<p><strong>Horaires :</strong> Consultez nos horaires actuels de bus vélo pour planifier votre journée.</p>
<p><strong>Surfaces routières :</strong> Asphalte principalement lisse ; attention aux zones humides sur les sections ombragées ou côtières.</p>
</div>
</div>
...
<li>Simple, rapide, à l'échelle de l'île.</li>
</ul>
<p><a href="https://mallorcacycleshuttle.company.site/products/Rescue-&-Recovery-c15728236" target="_blank" rel="noopener noreferrer">Souscrivez une couverture</a> avant de partir pour pouvoir rouler loin sans hésiter.</p>
</div>
</div>
...
<div class="info-card-content">
<p>Utilisez le bus vélo vers Port d'Andratx depuis Port de Pollença/Alcúdia/Playa de Muro et depuis Peguera, Playa de Palma et Santa Ponsa vers Port de Pollença.</p>
<p><a href="https://mallorcacycleshuttle.company.site/products/Scheduled-Bike-Buses-c15728235" target="_blank" rel="noopener noreferrer" class="cta">Voir les horaires et réserver →</a></p>
</div>
</div>
...
<div class="info-card-content">
<p>Grands kilomètres, grand dénivelé, grand littoral, grandes montagnes.</p>
<p>Le Défi Big Daddy est le chef-d'œuvre d'une journée de Majorque.</p>
<p>Planifiez vos cafés, respectez les montées, emportez ce dont vous avez besoin et accordez-vous du temps.</p>
<p>Ensuite, allez voir pourquoi les cyclistes reviennent en disant que c'était leur meilleur jour à vélo.</p>
</div>
</div>
...
<h3>Équipement Finisher</h3>
</div>
<div class="info-card-content">
<p><strong>Célébrez votre réussite !</strong></p>
<p>Obtenez votre t-shirt exclusif de finisher Port d'Andratx-Port de Pollença et montrez au monde que vous avez conquis ce parcours épique.</p>
<p style="color: var(--brand, #f10000); font-weight: 700; margin-top: 1rem;">Acheter maintenant →</p>
</div>
</div>
...
<h3>Réservez votre navette</h3>
</div>
<div class="info-card-content">
<p><strong>Besoin d'un transport pour commencer votre aventure ?</strong></p>
<p>Parcourez toutes les villes de départ et réservez votre navette vers Port d'Andratx ou Port de Pollença. Nous nous occupons de vous !</p>
<p style="color: var(--brand, #f10000); font-weight: 700; margin-top: 1rem;">Voir les navettes →</p>
</div>
</div>
...
<h2 id="north-routes" class="route-direction-header">Routes Nord – Andratx → Pollença</h2>
</div>
  ...
  <div class="route-item" id="route-north-1">
    <div class="route-header" onclick="toggleRoute('north-1')">
      <div class="route-title-section">
        ...
        <div>
          <div class="route-title">Défi Big Daddy (8 cols classifiés)</div>
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Section côtière + Port des Canonge + Port Valldemossa → long côté Puig Major → aqueduc → Coll dels Reis → Sa Calobra (descente et montée) → Lluc → Pollença/Port. Très difficile.</p>
...
<div class="route-section">
<h2 id="south-routes" class="route-direction-header">Routes Sud – Pollença → Andratx</h2>
</div>
  ...
  <div class="route-item" id="route-south-3">
    <div class="route-header" onclick="toggleRoute('south-3')">
      <div class="route-title-section">
        <span class="route-icon">▶</span>
        <div>
          <div class="route-title">Défi Big Daddy (inversé)</div>
          <div class="route-stats-inline">
            <span>📏 167 km</span>
            <span>⛰️ 4 121 m</span>
            <span class="difficulty-badge difficulty-very-hard">Très Difficile</span>
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Comme ci-dessus conceptuellement, incluant les trois « ports » (Canonge, Valldemossa, Sa Calobra). Réservé aux grimpeurs confirmés.</p>
...
<img src="/img/finishers-tshirt-andratx-pollenca.webp" alt="T-Shirt Finisher Andratx-Pollença" style="width: 100%; height: 100%; object-fit: cover; display: block;">
</div>
<div style="flex: 1 1 400px; padding: 2.5rem;">
<h2 style="color: var(--brand, #f10000); margin-bottom: 0.75rem; font-size: 1.75rem; font-weight: 700;">Commémorez votre sortie</h2>
<h3 style="color: #333; font-size: 1.2rem; font-weight: 600; margin-bottom: 0.75rem;">T-Shirt Finisher Andratx-Pollença</h3>
<p style="color: #666; font-size: 1rem; margin-bottom: 1.5rem; line-height: 1.6;">Célébrez l'achèvement de ce parcours épique avec notre t-shirt exclusif de finisher. Disponible en plusieurs couleurs et tailles.</p>
