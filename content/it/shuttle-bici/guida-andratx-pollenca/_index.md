...
Non diciamo che sia facile. Non diciamo che sia per tutti.
</p>

<div class="hero-intro-banner">
<div class="hero-intro-content">
<p class="hero-intro-centered fade-in-up">
Diciamo che è <strong>fantastico</strong>.
</p>
<p class="hero-intro-main fade-in-up delay-1">
Per il tuo <a href="#north-routes" class="highlight-red hero-link">«miglior giorno in bici di sempre»</a> – da <strong>Port d'Andratx</strong> a <strong>Port de Pollença</strong> attraverso l'eccezionale <span class="highlight">Serra de Tramuntana</span> di Maiorca – l'ultimo <a href="#south-routes" class="highlight-red hero-link">da costa a costa</a>
</p>
<p class="hero-intro-features fade-in-up delay-2">
Salite sceniche e impegnative • Discese ampie e scorrevoli • Asfalto liscio come il burro • Soste caffè regolari • Paradiso del ciclismo
</p>
</div>
</div>
...
.hero-link:hover {
  ...
  box-shadow: 0 6px 20px rgba(241, 0, 0, 0.35);
}
...
<h3>Scegli la tua avventura</h3>
</div>
<div class="info-card-content">
<p>11 percorsi diversi con download GPX completi e profili altimetrici</p>
</div>
</div>
...
<h3>Maestosità della montagna</h3>
</div>
<div class="info-card-content">
<p>Pedala attraverso la Serra de Tramuntana, Patrimonio Mondiale UNESCO</p>
</div>
</div>
...
<div class="info-card-content">
<p>Conquista passi leggendari tra cui Sa Calobra e Puig Major</p>
</div>
</div>
...
<h3>Bellezza costiera</h3>
</div>
<div class="info-card-content">
<p>Splendide viste sul Mediterraneo e affascinanti villaggi costieri</p>
</div>
</div>
...
<h3>Strade perfette</h3>
</div>
<div class="info-card-content">
<p>Asfalto liscio, corsie ampie e infrastrutture bike-friendly</p>
</div>
</div>
...
<h3>Cultura del caffè</h3>
</div>
<div class="info-card-content">
<p>Caffetterie tradizionali maiorchine, perfettamente distanziate per le soste</p>
</div>
</div>
...
<h3>Pedalare tutto l'anno</h3>
</div>
<div class="info-card-content">
<p>Clima mediterraneo mite, ideale per pedalare per oltre 10 mesi l'anno</p>
</div>
</div>
...
<h3>Prima la sicurezza</h3>
</div>
<div class="info-card-content">
<p>Strade ben mantenute con piste ciclabili dedicate in molte zone</p>
</div>
</div>
...
<h3>Kit da finisher</h3>
</div>
<div class="info-card-content">
<p>Commemora la tua impresa epica con merchandising esclusivo</p>
</div>
</div>
...
<div class="info-card-content">
<p>Consigli interni su orari migliori, meteo e chicche nascoste</p>
</div>
</div>
...
<h3>Opzioni flessibili</h3>
</div>
<div class="info-card-content">
<p>Percorsi per tutti i livelli – da moderati a sfide molto dure</p>
</div>
</div>
...
<h3>Prenota il tuo shuttle</h3>
</div>
<div class="info-card-content">
<p>Prenota lo shuttle bici per iniziare la tua avventura</p>
</div>
</div>
...
.info-card::before {
  ...
  right: 0;
  height: 4px;
  background: linear-gradient(90deg, transparent 0%, var(--brand-color) 20%, var(--brand-color) 80%, transparent 100%);
  opacity: 0.7;
...
<h2 id="north-routes" class="route-direction-header">Itinerari Nord – Andratx → Pollença</h2>
</div>
...
<div class="route-accordion">
  ...
  <div class="route-item" id="route-north-1">
    <div class="route-header" onclick="toggleRoute('north-1')">
      <div class="route-title-section">
        ...
        <div>
          <div class="route-title">Standard – Port d'Andratx → Port de Pollença</div>
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Tratto costiero → Puig Major (lato facile) → 14 km di discesa verso Sóller → strada costiera via Deià, Valldemossa, Banyalbufar, Estellencs. Il percorso diretto. Fantastico!</p>
  ...
  <div class="route-item" id="route-north-2">
    <div class="route-header" onclick="toggleRoute('north-2')">
      <div class="route-title-section">
        <span class="route-icon">▶</span>
        <div>
          <div class="route-title">Via Caimari</div>
          <div class="route-stats-inline">
            <span>📏 132 km</span>
            <span>⛰️ 2,573 m</span>
            <span class="difficulty-badge difficulty-moderate">Moderate</span>
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Come lo Standard ma svoltando all'interno dopo Sóller → salita a Orient → Alaró → Caimari → Lluc → Pollença. Variante interna scenica.</p>
  ...
  <div class="route-item" id="route-north-3">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Tratto costiero + discesa a Port Valldemossa e risalita (400 m di dislivello in giù & su per ciascun verso) → poi finale costiero standard. Un'aggiunta tosta.</p>
  ...
  <div class="route-item" id="route-north-4">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Tratto costiero + Port Valldemossa, poi Puig Major → a sinistra all'acquedotto → Coll dels Reis → giù a Sa Calobra, risalita → Lluc → discesa verso Pollença. Duro.</p>
  ...
  <div class="route-item" id="route-north-5">
    <div class="route-header" onclick="toggleRoute('north-5')">
      <div class="route-title-section">
        <span class="route-icon">▶</span>
        <div>
          <div class="route-title">La Grande Sfida (8 passi classificati)</div>
          <div class="route-stats-inline">
            <span>📏 162 km</span>
            <span>⛰️ 4,267 m</span>
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Tratto costiero + Port des Canonge + Port Valldemossa → lato lungo del Puig Major → acquedotto → Coll dels Reis → Sa Calobra (giù & su) → Lluc → Pollença/Port. Molto duro.</p>
  ...
  <div class="route-item" id="route-north-6">
    <div class="route-header" onclick="toggleRoute('north-6')">
      <div class="route-title-section">
        <span class="route-icon">▶</span>
        <div>
          <div class="route-title">Ritorno via Coll de Sóller e Valle di Orient</div>
          <div class="route-stats-inline">
            <span>📏 137 km</span>
            <span>⛰️ 2,360 m</span>
            <span class="difficulty-badge difficulty-hard">Hard</span>
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Completa il classico tratto costiero e poi affronta i 51 tornanti, superando il Coll de Sóller, prima di scorrere nella tranquilla Valle di Orient. Un altro per noi scalatori. Giornata super. Le bevande di recupero la sera saranno meritatissime!</p>
...
<div class="route-section">
<h2 id="south-routes" class="route-direction-header">Itinerari Sud – Pollença → Andratx</h2>
</div>

<div class="route-accordion">
  <!-- Route 1: South Standard -->
  <div class="route-item" id="route-south-1">
    <div class="route-header" onclick="toggleRoute('south-1')">
      <div class="route-title-section">
        <span class="route-icon">▶</span>
        <div>
          <div class="route-title">Standard – Port de Pollença → Port d'Andratx</div>
          <div class="route-stats-inline">
            <span>📏 121 km</span>
            <span>⛰️ 2,700 m</span>
            <span class="difficulty-badge difficulty-moderate">Moderate</span>
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Coll de Femenia → oltre il bivio Lluc/Sa Calobra → lato facile del Puig Major → 14 km di discesa verso Sóller → costa via Deià, Valldemossa, Banyalbufar, Estellencs → Port d'Andratx. Il ritorno più diretto. Fantastico!</p>
  ...
  <div class="route-item" id="route-south-2">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Femenia → Lluc → Puig Major → Sóller → costa + aggiunte: andata e ritorno a Port des Canonge e Port Valldemossa → finale costiero sud-ovest fino ad Andratx.</p>
  ...
  <div class="route-item" id="route-south-3">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Femenia → Lluc → Puig Major → Sóller → Deià → Valldemossa → Esporles → Puigpunyent → Galilea → Es Capdellà → Port d'Andratx. Passa un po' di tempo lontano dalla costa e off the grid!</p>
  ...
  <div class="route-item" id="route-south-4">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Concettualmente come sopra, includendo i tre "ports" (Canonge, Valldemossa, Sa Calobra). Solo per scalatori forti.</p>
  ...
  <div class="route-item" id="route-south-5">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Completa il classico coast-to-coast includendo quello che alcuni considerano i migliori 20 km di strada per ciclisti in Europa – l'andata e ritorno al faro di Cap de Formentor. Giornata epica!</p>
      ...
      plugins: {
        ...
        tooltip: {
          callbacks: {
            ...
            label: (context) => 'Elevazione: ' + context.parsed.y.toFixed(0) + ' m'
          }
        }
      },
      scales: {
        ...
        y: {
          title: { display: true, text: 'Elevazione (m)' }
        }
      },
      interaction: {
        intersect: false,
...
<h2 style="color: var(--brand, #f10000); margin-bottom: 0.75rem; font-size: 1.75rem; font-weight: 700;">Commemora la tua impresa</h2>
<h3 style="color: #333; font-size: 1.2rem; font-weight: 600; margin-bottom: 0.75rem;">T-shirt Finisher Andratx-Pollença</h3>
<p style="color: #666; font-size: 1rem; margin-bottom: 1.5rem; line-height: 1.6;">Festeggia il completamento di questo percorso epico con la nostra T-shirt da finisher esclusiva. Disponibile in più colori e taglie.</p>
