---
title: "Guia mestra de ciclisme: Andratx a Pollença"
description: "Guia completa per pedalar d'Andratx a Pollença a través de la serra de Tramuntana"
translationKey: "guide-andratx-pollenca"
---

<p class="header-subtitle">
No diem que sigui fàcil. No diem que sigui per a tothom.
</p>
...
.hero-intro-centered strong {
  background: linear-gradient(135deg, var(--brand-color) 0%, #ff4444 100%);
...
<h3>Tria la teva aventura</h3>
</div>
<div class="info-card-content">
<p>11 rutes diferents amb descàrregues GPX completes i perfils d'elevació</p>
</div>
</div>
...
<h3>Majestat de la muntanya</h3>
</div>
<div class="info-card-content">
<p>Pedala per la Serra de Tramuntana, Patrimoni Mundial de la UNESCO</p>
</div>
</div>
...
<h3>Pujades èpiques</h3>
</div>
<div class="info-card-content">
<p>Conquista cols llegendaris com Sa Calobra i Puig Major</p>
</div>
</div>
...
<h3>Bellesa costanera</h3>
</div>
<div class="info-card-content">
<p>Vistes mediterrànies espectaculars i pobles costaners amb encant</p>
</div>
</div>
...
<h3>Carreteres perfectes</h3>
</div>
<div class="info-card-content">
<p>Asfalt llis, carrils amples i infraestructura amigable amb la bici</p>
</div>
</div>
...
<h3>Cultura del cafè</h3>
</div>
<div class="info-card-content">
<p>Cafès tradicionals mallorquins, perfectament espaiats per a les parades</p>
</div>
</div>
...
<h3>Pedalar tot l'any</h3>
</div>
<div class="info-card-content">
<p>Clima mediterrani suau, ideal per pedalar més de 10 mesos a l'any</p>
</div>
</div>
...
<h3>La seguretat primer</h3>
</div>
<div class="info-card-content">
<p>Carreteres ben mantingudes amb carrils bici senyalitzats en moltes zones</p>
</div>
</div>
...
<h3>Equip de finisher</h3>
</div>
<div class="info-card-content">
<p>Commemora la teva ruta èpica amb marxandatge exclusiu</p>
</div>
</div>
...
<h3>Coneixement local</h3>
</div>
<div class="info-card-content">
<p>Consells d'expert sobre millors horaris, meteorologia i racons amagats</p>
</div>
</div>
...
<h3>Opcions flexibles</h3>
</div>
<div class="info-card-content">
<p>Rutes per a tots els nivells - de moderades a desafiaments molt durs</p>
</div>
</div>
...
<div class="info-card-content">
<p>Reserva la llançadora de bicicletes per començar la teva aventura</p>
</div>
</div>
...
.info-card::before {
  ...
  right: 0;
  height: 4px;
  background: linear-gradient(90deg, var(--brand-color, #f10000) 0%, #ff4444 100%);
...
<h2 id="north-routes" class="route-direction-header">Rutes del Nord – Andratx → Pollença</h2>
</div>
...
<div class="route-accordion">
  ...
  <div class="route-item" id="route-north-1">
    <div class="route-header" onclick="toggleRoute('north-1')">
      <div class="route-title-section">
        ...
        <div>
          <div class="route-title">Estàndard – Port d'Andratx → Port de Pollença</div>
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Tram costaner → Puig Major (cara fàcil) → 14 km de descens cap a Sóller → carretera de costa per Deià, Valldemossa, Banyalbufar, Estellencs. La ruta directa. Brillant!</p>
  ...
  <div class="route-item" id="route-north-2">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Igual que Estàndard però girant cap a l'interior després de Sóller → ascens a Orient → Alaró → Caimari → Lluc → Pollença. Variant interior escènica.</p>
  ...
  <div class="route-item" id="route-north-3">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Tram costaner + baixada a Port Valldemossa i pujada de retorn (400 m de desnivell de baixada i pujada a cada sentit) → després final costaner estàndard. Afegit dur.</p>
  ...
  <div class="route-item" id="route-north-4">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Tram costaner + Port Valldemossa, després Puig Major → esquerra a l'aqüeducte → Coll dels Reis → baixar a Sa Calobra, pujar de nou → Lluc → baixada cap a Pollença. Dur.</p>
  ...
  <div class="route-item" id="route-north-5">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Tram costaner + Port des Canonge + Port Valldemossa → cara llarga del Puig Major → aqüeducte → Coll dels Reis → Sa Calobra (baixar & pujar) → Lluc → Pollença/Port. Molt dur.</p>
  ...
  <div class="route-item" id="route-north-6">
    <div class="route-header" onclick="toggleRoute('north-6')">
      <div class="route-title-section">
        <span class="route-icon">▶</span>
        <div>
          <div class="route-title">Tornada pel Coll de Sóller i la vall d'Orient</div>
          <div class="route-stats-inline">
            <span>📏 137 km</span>
            <span>⛰️ 2,360 m</span>
            <span class="difficulty-badge difficulty-hard">Hard</span>
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Completa el tram costaner clàssic i afronta després els 51 revolts passant pel Coll de Sóller abans de lliscar per la tranquil·la vall d'Orient. Una altra pels escaladors. Dia rodó. Les begudes de recuperació al vespre seran ben merescudes!</p>
...
<div class="route-section">
<h2 id="south-routes" class="route-direction-header">Rutes del Sud – Pollença → Andratx</h2>
</div>

<div class="route-accordion">
  <!-- Route 6: South Estàndard -->
  <div class="route-item" id="route-south-1">
    <div class="route-header" onclick="toggleRoute('south-1')">
      <div class="route-title-section">
        <span class="route-icon">▶</span>
        <div>
          <div class="route-title">Estàndard – Port de Pollença → Port d'Andratx</div>
          <div class="route-stats-inline">
            <span>📏 121 km</span>
            <span>⛰️ 2,700 m</span>
            <span class="difficulty-badge difficulty-moderate">Moderate</span>
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Coll de Femenia → passar l'encreuament de Lluc/Sa Calobra → cara fàcil del Puig Major → 14 km de descens cap a Sóller → costa per Deià, Valldemossa, Banyalbufar, Estellencs → Port d'Andratx. El retorn més directe. Brillant!</p>
  ...
  <div class="route-item" id="route-south-2">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Femenia → Lluc → Puig Major → Sóller → costa + afegits: baixada i pujada a Port des Canonge i Port Valldemossa → final costaner sud-oest fins a Andratx.</p>
  ...
  <div class="route-item" id="route-south-3">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Femenia → Lluc → Puig Major → Sóller → Deià → Valldemossa → Esporles → Puigpunyent → Galilea → Es Capdellà → Port d'Andratx. Passa una estona lluny de la costa i fora del circuit!</p>
  ...
  <div class="route-item" id="route-south-4">
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Conceptualment com a dalt, incloent els tres "ports" (Canonge, Valldemossa, Sa Calobra). Només per a escaladors forts.</p>
  ...
  <div class="route-item" id="route-south-5">
    <div class="route-header" onclick="toggleRoute('south-5')">
      <div class="route-title-section">
        <span class="route-icon">▶</span>
        <div>
          <div class="route-title">Tornada per Cap de Formentor</div>
          <div class="route-stats-inline">
            <span>📏 162 km</span>
            <span>⛰️ 3,500 m</span>
    ...
    <div class="route-content">
      <div class="route-content-inner">
        <p class="route-description">Completa el clàssic coast-to-coast incloent el que alguns consideren els millors 20 km de carretera per a ciclistes d'Europa: l'anada i tornada al far del Cap de Formentor. Dia èpic!</p>
...
<img src="/img/finishers-tshirt-andratx-pollenca.webp" alt="Samarreta Finisher Andratx-Pollença" style="width: 100%; height: 100%; object-fit: cover; display: block;">
</div>
...
<p style="color: #666; font-size: 1rem; margin-bottom: 1.5rem; line-height: 1.6;">Celebra haver completat aquest itinerari èpic amb la nostra samarreta de finisher exclusiva. Disponible en diversos colors i talles.</p>
